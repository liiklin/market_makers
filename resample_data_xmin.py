...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_file", help="file to extract data from")
    parser.add_argument("--out_file", help="file to save resampled data to")
    parser.add_argument("--freq", help="resample freq in minutes (defaults to 30 min)", default=30 )
    args = parser.parse_args()

    main(args.in_file, args.out_file, int(args.freq))